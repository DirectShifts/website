jQuery(document).ready(function () {
    ...
    jQuery.ajax({
      ...
      success: function (result) {
            ...
            <div class="survey-bnr-wrap">
                ...
                <div class="survey-bnr-right">
                    ...
                    <p class="site-body-text-b2 mb-20">
                       Get key insights on staffing, pay, and schedules shaping the clinical workforce.
                    </p>
                    <div class="dirctregstrbtn"><a href="https://www.directshifts.com/state-of-the-clinical-workforce-report-2025?utm_source=mkt-website&amp;utm_medium=open-jobs&amp;utm_campaign=sign-up&amp;utm_content=02122026" target="_blank">Download Now</a></div>
        ...
        if (i === 4){ html += `<tr><td colspan="2" class="cus-feb-bnr"><div class="contribute-banner"><div class="dollar-icnw-wrap"><img src="https://cdn.prod.website-files.com/5abebcf1b3e0cb4bb9718bba/6992d017d6611dd408c98378_Dollar%20Icon.svg"></div><div class="site-v-flex"><h5 class="site-heading-h5 site-text-white">Know Your Worth.</h5><p class="site-body-text-b2 mb-0 site-text-white">Help build the ultimate clinical pay database for 2026.</p></div><div class="site-btn-wrapper"><a class="site-btn-solid cc-btn-white" href="https://directshiftsforms.fillout.com/t/j4ezJ3PFryus" target="_blank">Contribute & Compare</a></div></div></td></tr>`; }
