    ...
    jQuery.ajax({
      ...
      success: function (result) {
        ...
        if(result.jobs.length <= 3){ jQuery('.sidebtmlft').addClass('notFoundResult'); }
            ...
            html = '<div class="nrfound"><h2>We may have job openings for you, even if it\'s not yet listed!</h2><p>Our job listings are constantly evolving. Connect with us to uncover potential job openings tailored to your needs. We\'re here to help you find the right job for you. </p><a class="utm-btn-val" href="https://www.directshifts.com/speak-to-a-recruiter">Connect with a clinician partner</a></div>';
