jQuery(document).ready(function () {
    ...
    jQuery.ajax({
      ...
      success: function (result) {
        ...
        var pageJobTitle = $("title").text();
        var mktPageTitle = pageJobTitle.toLowerCase().replace(/\s+/g, '-'); 
